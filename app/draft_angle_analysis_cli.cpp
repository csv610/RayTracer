...
int main(int argc, char** argv) {
    argparse::ArgumentParser parser("draft_angle_analysis", 
        "Analyze draft angles on mesh surfaces relative to a pull direction.");

    parser.add_positional("input", "Input mesh file (OFF/PLY format)");
    parser.add_argument("-o", "Output colored mesh file (default: draft_angles.off)", "draft_angles.off");
